...
export const plot = ({ filename }: { filename: string }) => {
  run(
    `axicli ./src/axidraw/${filename} --speed_pendown 50 --speed_penup 50 --accel 70 --pen_pos_down 8 --pen_pos_up 36 --pen_rate_lower 100 --pen_rate_raise 100 --pen_delay_down 0 --pen_delay_up 0`,
    (err, data, stderr) => {
